...
@section('content')
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form method="post" action="{{ route('cats.store') }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="form-group{{ $errors->has('summary') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="summary" class="form-control" placeholder="summary" rows="8" cols="80">{{ old('summary') }}</textarea>
